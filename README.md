...
Создайте файлы окружения `/src/.env` и `/db.env` по образцам.

Создайте файлы конфигурации AWS `/src/.aws/`, подробее в [документации](https://yandex.cloud/ru/docs/storage/tools/boto).
